...
export function LeaderboardPage() {
  return (
    <div className="p-6 md:p-10 max-w-6xl mx-auto min-h-screen bg-slate-50/50 dark:bg-slate-900 transition-colors duration-300">
      {/* Header */}
      <motion.div 
                ...
                <CardContent className="pt-8 pb-6 text-center">
                  ...
                  <div className="flex items-center justify-center gap-4 text-sm bg-gray-50 dark:bg-slate-900/50 py-3 rounded-xl mx-2 border border-gray-100 dark:border-slate-700">
                    <div className="text-center">
                      <p className="font-black text-gray-900 dark:text-white">{entry.xp.toLocaleString()}</p>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3">
                          ...
                          {isCurrentUser && (
                            <Badge className="bg-white text-blue-600 hover:bg-white text-[10px] px-2.5 uppercase py-0.5 font-black border-none">
                              Bu Siz
                            </Badge>
                          )}
                        </div>
                      ...
                      <div className="flex items-center gap-5 sm:gap-8 text-sm">
                        ...
                        <div className="text-right hidden sm:block">
                          <p className={`font-black text-lg ${isCurrentUser ? 'text-white' : 'text-gray-900 dark:text-white'}`}>{entry.xp.toLocaleString()}</p>
